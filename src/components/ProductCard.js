...
export default function ProductCard({ product, onUpdateStock, onClick }) {
  ...
  return (
    <div className="flex flex-col items-center bg-white p-4 rounded-2xl shadow-sm border border-gray-200 transition-all hover:shadow-md">
      ...
      <div className="w-full text-center mb-4 cursor-pointer" onClick={() => onClick(product)}>
        ...
        {/* Mostra o Tipo e o Material juntos */}
        <p className="text-sm font-medium text-gray-600">
          {product.codigo} • {product.tipo} {product.material ? `(${product.material})` : ''}
        </p>
      </div>
